...
- Prefer `python -m moldvision ...` for dataset creation/conversion/training.
...
- `scripts/remap_coco_ids.py`: Deprecated wrapper. Prefer `python -m moldvision dataset normalize-coco-ids ...`.
