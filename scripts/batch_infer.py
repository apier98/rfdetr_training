...
from infer_webcam import run_inference, preprocess_frame_to_tensor
...
def main():
    ...
    # module_for_torch same logic as other scripts
    ...
    for p in imgs:
        ...
        # parse_model_output returns (boxes,scores,labels) or (boxes,scores,labels,masks)
